...
class DecisionService extends ChangeNotifier {
  ...
  final String _apiKey = 'AIzaSyB5jFAjZcVL6rLflwh75jobxxz0ujSI3yw';
  ...
  Future<void> analyzeDecision(String decisionPrompt) async {
    ...
    try {
      ...
      3. ### SWOT Analysis
      Provide a SWOT (Strength, Weaknesses, Opportunities, Threats) analysis for decision.
      
      Ensure the markdown is well-formatted easy to read. Do not include extra text outside of these headers.
      ''';
